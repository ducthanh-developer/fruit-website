                                                ...
                                                <table id="example2" class="table table-bordered table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 25%" class="text-center">Người đánh giá </th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $rating->nameProduct }}</td>
                                                            <td>ID : {{ $rating->idUser }} ||  {{ $rating->fullName }}</td>
                                                            <td class="text-center">{{ $rating->points}} <i class="fa-solid fa-star" style="color: #FFD700	"></i></td>
                                                            <td class="text-center">
                                                                <a class="btn btn-danger btn-sm" href="{{URL::to('/deleteRating/'.$rating->idRating)}}">
