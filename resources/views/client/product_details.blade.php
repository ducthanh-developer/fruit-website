						...
						<div class="wrap-main-pic-100 bo-all-1 bocl12 pos-relative">
							<div class="main-frame">
								<div class="wrap-main-pic">
									<div class="main-pic">
										<img src="{{$data->imgUrl}}" alt="IMG-SLIDE">
									</div>
								</div>
							</div>
					...
					<div class="p-t-36">
						...
						<div class="flex-w flex-sb-t bo-b-1 bocl15 p-b-37">
							<div class="wrap-pic-w size-w-56">
								<img src="https://i.pinimg.com/736x/16/b2/e2/16b2e2579118bf6fba3b56523583117f.jpg" alt="AVATAR">
							</div>
						...
						@endforeach
						<!-- Add review -->
						<form class="w-full p-t-42" action="javascript:void(0)" enctype="multipart/form-data" method="POST" >
						{{ method_field('PUT') }}
							...
							<div class="row p-t-12">
								<div class="col-sm-6 p-b-30">
									<input id="name-cmt" class="txt-s-101 cl3 plh1 size-a-25 bo-all-1 bocl11 focus1 p-rl-20" type="text" name="name" placeholder="Họ và tên *">
								</div>

								<div class="col-sm-6 p-b-30">
									<input id="email-cmt" class="txt-s-101 cl3 plh1 size-a-25 bo-all-1 bocl11 focus1 p-rl-20" type="text" name="email" placeholder="Email *">
								</div>

								<div class="col-12 p-b-30">
									<textarea id="content-cmt" class="txt-s-101 cl3 plh1 size-a-26 bo-all-1 bocl11 focus1 p-rl-20 p-tb-10" name="review" placeholder="Nội dung *"></textarea>
								</div>
							</div>
