                ...
                <ul>
                    ...
                    <li data-transition="fade">
                        ...
                        <h2 class="tp-caption tp-resizeme layer2  text-success"
                            ...
                            data-y="['center']" data-hoffset="['0', '0', '0', '0']" data-voffset="['30', '30', '20', '0']"
                            data-width="['960','960','768','576']" data-height="['auto']" data-whitespace="['normal']"
                                ...
                                <div class="block1-content flex-col-c-m p-b-46">
                                    ...
                                    <div class="block1-wrap-icon flex-c-m flex-w trans-05">
                                        ...
                                        <form action="{{ route('add-cart') }}" method="post" id="form-add">
                                            @csrf
                                            <input type="hidden" name="idProduct" value="{{ $value->idProductDetail }}">
                                            <input type="hidden" name="nameProduct" value="{{ $value->nameProduct }}">
                                            <input type="hidden" name="imgUrl" value="{{ $value->imgUrl }}">
                            ...
                            <div class="flex-col-l p-b-25 p-rl-15">
                                ...
                                <div class="flex-w flex-t w-full p-t-5">
                                    ...
                                    <div class="wrap-arrow-slick6 flex-w m-t-6">
                                        <button class="arrow-slick6 prev-slick6"><i class="fa fa-angle-left"
                                                aria-hidden="true"></i></button>
                                        <button class="arrow-slick6 next-slick6"><i class="fa fa-angle-right"
                                                aria-hidden="true"></i></button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex-col-c-m bg0 p-rl-15 p-t-37 p-b-35">
                            ...
                            <div class="flex-w flex-c-m p-t-30">
                                <a href="#" class="wrap-pic-max-s pos-relative lh-10 hov6 m-all-8">
                                    <img class="hov6-child1 trans-04" src="images/icons/icon-instagram.png"
                                        alt="instagram">
